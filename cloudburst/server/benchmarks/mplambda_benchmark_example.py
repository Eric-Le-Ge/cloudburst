...
dc = CloudburstConnection('a384e005f76dc45d3aa75f4cf42f31b5-881558085.us-east-1.elb.amazonaws.com', '52.90.84.195') # function_elb, driver_node_ip
...
f = open("result_" + "k_15_lambda_100" + ".txt", "w")
...
while run < 24:
    ...
    for i in range(100): # parallely run. 10 is the number of function requests. TODO: spin up more nodes
        future_list.append(cloud_func('ae23157492e35435592e278914eb3c75-389457656.us-east-1.elb.amazonaws.com', solution_key)) # routing_elb
    count = 1
    print("[[",future_list,"]]")
